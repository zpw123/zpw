...
public class Goods implements Serializable{
	private static final long serialVersionUID = 195367809650211097L;
	private Integer gid;
	...
	public Goods(Integer gid, String gname, String des, double price,
			String pic, Integer status, Integer spid, Integer aid,
			String sname, String aname, String flag, String mark, String temp) {
		super();
		this.gid = gid;
		this.gname = gname;
		this.des = des;
